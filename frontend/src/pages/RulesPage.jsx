...
function Rule({ children }) {
  return (
    <div style={{ display:'flex', gap:8, marginBottom:8, alignItems:'flex-start' }}>
      <span style={{ color:'#1a7a3c', fontWeight:700, lineHeight:1.5 }}>•</span>
  ...
  return (
    <div>
      <div style={{ marginBottom:16 }}>
        <h2 style={{ margin:'0 0 4px', fontSize:20, fontWeight:600 }}>📖 How KickBet Works</h2>
        <div style={{ fontSize:13, color:'#888' }}>
          The complete rulebook. KickBet is a pool-based (parimutuel) betting game with a Girls Education fund.
        </div>
      </div>

      <Section icon="💰" title="Money & the Pool">
        <Rule>Join by committing money to a shared pool — <strong>minimum ₹10,000</strong> for your first commitment.</Rule>
        <Rule>You can top up anytime, but only <strong>increase</strong> your commitment — there's no withdrawing back down.</Rule>
        <Rule>Pay the admin via their listed methods: <strong>UPI / Paytm, QR code, bank transfer (with IFSC), or cash</strong>.</Rule>
      ...
      <Section icon="⚽" title="Betting — Parimutuel (Pool) Odds">
        <div style={{ background:'#e8f5ed', borderRadius:8, padding:'10px 12px', marginBottom:12, fontSize:12.5 }}>
      ...
      <Section icon="🛡️" title="Admins">
        ...
        <Rule>Admins manage matches, set questions and minimum stakes, settle results, manage payment methods, and acknowledge pool commitments.</Rule>
      </Section>
